...
if (imageUpload) {
    imageUpload.addEventListener("change", async function (e) {
        ...
        // Preview rendering
        // Sa iyong JavaScript, siguraduhin na ang image preview element ay may ganitong style:
        const previewImg = document.getElementById('preview');
        previewImg.style.width = '512px';
        previewImg.style.height = '512px';
        previewImg.style.objectFit = 'cover'; // Ito ang sikreto para hindi ma-stretch
    }
        if (preview) {
            ...
            preview.style.objectFit = 'cover'; // Ito ang sikreto para hindi ma-stretch
        }
...
if (overlayImage) {
    ...
    try {
        ...
        // Extended Info
        if (corrosionType) corrosionType.innerText = `${data.defect_type} | Density: ${data.density}%`;
